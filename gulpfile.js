...
gulp.task("build-react", function() {
    var options = {
        entries: "./3d.jsx", // Entry point
        extensions: [".jsx"],          // consider files with these extensions as modules
        debug: argv.production ? false : true,  // add resource map at the end of the file or not
        paths: ["./"]         // This allows relative imports in require, with './scripts/' as root
    };
